            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-8 gap-4">
                    ...
                    <div className="flex flex-col md:flex-row gap-2 md:gap-4 items-center">
                        ...
                        <button
                            ...
                            disabled={isPrinting}
                            className="no-print bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 px-6 rounded-lg shadow-md transition duration-300 flex items-center"
                        >
                ...
                <div ref={componentRef} className="bg-white p-6 rounded-xl shadow-lg">
                    ...
                    <div className="hidden print:block report-header">
                        <h1 className="text-2xl font-bold text-center mb-4">Product Inventory Report</h1>
                    ...
                    <div className="stats-container bg-white print:bg-transparent rounded-xl shadow-md print:shadow-none p-6 mb-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
                            {[
                                ...
                                <div key={index} className="bg-gray-50 print:bg-gray-100 p-4 rounded-lg border border-gray-200">
                                    <h3 className="text-sm font-medium text-gray-600">{stat.title}</h3>
                                    <p className="text-2xl font-bold text-blue-600 print:text-blue-800 mt-2">{stat.value}</p>
                                </div>
                            ))}
                        </div>
                    </div>
